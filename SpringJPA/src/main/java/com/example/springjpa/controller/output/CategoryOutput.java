...
public class CategoryOutput {
    ...
    private Page<CategoryEntity> listResult = new Page<CategoryEntity>() {
        @Override
    ...
    public Page<CategoryEntity> getListResult() {
        return listResult;
    }

    public void setListResult(Page<CategoryEntity> listResult) {
